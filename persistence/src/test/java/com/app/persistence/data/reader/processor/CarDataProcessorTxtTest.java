...
class CarDataProcessorTxtTest {
    @Autowired
    CarDataProcessor carDataProcessorTxt;

    @Test
    @DisplayName("When data source is txt and fetch is eager")
    void test1() {
        ...
        Assertions
                .assertThat(carDataProcessorTxt.process(EAGER))
                .hasSize(3)
    ...
    @Test
    @DisplayName("When data source is txt and fetch is lazy")
    void test2() {
        var expected = List.of(
        ...
        Assertions
                .assertThat(carDataProcessorTxt.process(LAZY))
                .hasSize(3)
                .isInstanceOf(List.class)
                .isEqualTo(expected);
    }
