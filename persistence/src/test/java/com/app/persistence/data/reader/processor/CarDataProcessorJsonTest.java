...
class CarDataProcessorJsonTest {
    @Autowired
    CarDataProcessor carDataProcessorJson;

    @Test
    @DisplayName("When data source is json and fetch is eager")
    void test1() {
        ...
        Assertions
                .assertThat(carDataProcessorJson.process(EAGER))
                .hasSize(3)
    ...
    @Test
    @DisplayName("When data source is json and fetch is lazy")
    void test2() {
        var expected = List.of(
        ...
        Assertions
                .assertThat(carDataProcessorJson.process(LAZY))
                .hasSize(3)
                .isInstanceOf(List.class)
                .isEqualTo(expected);
    }
