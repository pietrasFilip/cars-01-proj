...
import static com.app.persistence.model.car.CarComparator.byPrice;
...
class SortByPriceTest {
    ...
    void test1() {
        var carListExpected = List.of(
                Car.of(1L, "BMW", BigDecimal.valueOf(20), Color.WHITE, 200,
                        null),
                Car.of(2L, "BMW", BigDecimal.valueOf(2000), Color.BLUE, 2000,
                        null),
                Car.of(3L, "KIA", BigDecimal.valueOf(2000), Color.BLUE, 2000,
                        null)
        );
